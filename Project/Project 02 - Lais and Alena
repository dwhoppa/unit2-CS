...
## Design Statement
Our team developing a program using Arduino and DHT_11 sensors to monitor humidity and temperature required for growing the cabbages in greenhouses. The data will be uploaded to a real-time server with 48 hours and accessed via a secure login. This reliable, proven system will be ready within 3 weeks and will meet our client's needs (done using PyCharm)
